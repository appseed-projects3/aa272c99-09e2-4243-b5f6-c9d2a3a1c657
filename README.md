...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-21 02:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/aa272c99-09e2-4243-b5f6-c9d2a3a1c657.git
$ cd aa272c99-09e2-4243-b5f6-c9d2a3a1c657
```
